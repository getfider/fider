...
const testCases = [
  {
    ...
    expectedFull: '<p>Visit <a target="_blank" href="https://github.com" rel="noopener">GitHub</a> to learn more.</p>',
    expectedSimple: '<p>Visit <a target="_blank" href="https://github.com" rel="noopener">GitHub</a> to learn more.</p>'
