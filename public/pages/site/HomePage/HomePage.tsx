...
import { IdeaInput, ListIdeas, IdeasView } from './';
      ...
      <div className="page ui container">
        <div className="ui grid stackable">
          <div className="six wide column">
            <MultiLineText className="welcome-message" text={this.props.tenant.welcomeMessage || defaultWelcomeMessage} style="full" />
            <IdeaInput
