...
interface CompleteSignInProfileState {
  name: string;
}

export class CompleteSignInProfile extends React.Component<{}, CompleteSignInProfileState> {
  private form: Form;
                        ...
                        <div className="content">
                            ...
                            <Form ref={(f) => { this.form = f!; } } onSubmit={() => this.submit() }>
                              <div className="ui small action fluid input">
                                  <input onChange={(e) => this.setState({ name: e.currentTarget.value }) } type="text" placeholder="Your display name" className="small" />
