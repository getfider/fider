      ...
      <Modal.Window isOpen={this.state.showConfirmation} center={false} size="large">
        <Modal.Content>
          <Form ref={(f) => { this.form = f!; }}>
            ...
            <span className="info">This operation <strong>cannot</strong> be undone.</span>
          </Form>
        </Modal.Content>
        ...
        <Modal.Footer>
          ...
          <Button onClick={async () => this.close()}>
            Cancel
          </Button>
        </Modal.Footer>
      </Modal.Window>
    ...
    return (
      <div>
        ...
        <div className="ui list">
          <div className="item">
            <Button color="red" size="tiny" fluid={true} onClick={async () => this.setState({ showConfirmation: true })}>
