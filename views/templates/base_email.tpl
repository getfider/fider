...
<html>
	...
	<body bgcolor="#F7F7F7" style="font-size:18px">
		<table width="100%" bgcolor="#F7F7F7" cellpadding="0" cellspacing="0" border="0" style="text-align:center;font-size:18px;">
			...
			<tr>
				<td>
					<span style="color:#666;font-size:12px">{{ "This email was sent from a notification-only address that cannot accept incoming email. Please do not reply to this message." | translate }}</span>
				</td>
			</tr>
			<tr>
				<td height="40">&nbsp;</td>
