...
func TestSend_Success(t *testing.T) {
	...
	Expect(string(requests[0].body)).ContainsSubstring("Hello Hello! This is a test email sent from Fider. If you have received this email, It means your email settings are correct!")
...
func TestBatch_Success(t *testing.T) {
	...
	Expect(string(requests[0].body)).ContainsSubstring("Message-ID: ")
	Expect(string(requests[0].body)).ContainsSubstring("Hello Jon! This is a test email sent from Fider. If you have received this email, It means your email settings are correct!")
	...
	Expect(string(requests[1].body)).ContainsSubstring("Hello Arya! This is a test email sent from Fider. If you have received this email, It means your email settings are correct!")
}
