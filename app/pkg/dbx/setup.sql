...
INSERT INTO user_providers (user_id, provider, provider_uid, created_on) VALUES (4, 'facebook', 'FB2222', now());

INSERT INTO users (name, email, tenant_id, created_on, role) VALUES ('The Hulk', 'the.hulk@avengers.com', 2, now(), 1);
INSERT INTO user_providers (user_id, provider, provider_uid, created_on) VALUES (5, 'google', 'GO1111', now());
