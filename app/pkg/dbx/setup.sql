...
INSERT INTO tenants (name, subdomain, created_on, cname, invitation, welcome_message) VALUES ('Demonstration', 'demo', now(), '', '', '');
...
INSERT INTO tenants (name, subdomain, created_on, cname, invitation, welcome_message) VALUES ('Orange Inc.', 'orange', now(), 'feedback.orangeinc.com', '', '');
