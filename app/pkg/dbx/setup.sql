...
INSERT INTO tenants (name, subdomain, created_on, cname, invitation, welcome_message, status, is_private) VALUES ('Demonstration', 'demo', now(), '', '', '', 1, false);
...
INSERT INTO tenants (name, subdomain, created_on, cname, invitation, welcome_message, status, is_private) VALUES ('Avengers', 'avengers', now(), 'feedback.avengers.com', '', '', 1, false);
