...
func encode(user *entities.User) string {
...
func AddAuthUserCookie(ctx *web.Context, user *entities.User) {
...
func SetSignUpAuthCookie(ctx *web.Context, user *entities.User) {
