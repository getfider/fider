...
// ManageBilling2 is the page used by administrators for Stripe billing settings
func ManageBilling2() web.HandlerFunc {
	return func(c *web.Context) error {
		...
		return c.Page(http.StatusOK, web.Props{
			Page:  "Administration/pages/ManageBilling2.page",
...
func CreateStripePortalSession() web.HandlerFunc {
	return func(c *web.Context) error {
		...
		returnURL := c.BaseURL() + "/admin/billing2"
