...
func TestGetPostHandler(t *testing.T) {
	...
	post := &entities.Post{ID: 5, Number: 5, Title: "My First Post", Description: "Such an amazing description"}
...
func TestUpdatePostHandler_TenantStaff(t *testing.T) {
	...
	post := &entities.Post{ID: 5, Number: 5, Title: "My First Post", Description: "With a description"}
	bus.AddHandler(func(ctx context.Context, q *query.GetPostByNumber) error {
		if q.Number == post.Number {
			q.Result = post
			return nil
...
func TestUpdatePostHandler_DuplicateTitle(t *testing.T) {
	...
	post1 := &entities.Post{ID: 1, Number: 1, Title: "My First Post", Slug: "my-first-post"}
	post2 := &entities.Post{ID: 2, Number: 2, Title: "My Second Post", Slug: "my-second-post"}
	bus.AddHandler(func(ctx context.Context, q *query.GetPostByNumber) error {
...
func TestSetResponseHandler(t *testing.T) {
	...
	post := &entities.Post{ID: 1, Number: 1, Title: "My First Post", Slug: "my-first-post"}
	bus.AddHandler(func(ctx context.Context, q *query.GetPostByNumber) error {
		if q.Number == post.Number {
			q.Result = post
			return nil
...
func TestSetResponseHandler_Duplicate(t *testing.T) {
	...
	post1 := &entities.Post{ID: 1, Number: 1, Title: "The Post #1", Description: "The Description #1"}
	post2 := &entities.Post{ID: 2, Number: 2, Title: "The Post #2", Description: "The Description #2"}
	bus.AddHandler(func(ctx context.Context, q *query.GetPostByNumber) error {
		if q.Number == post1.Number {
			q.Result = post1
			return nil
...
func TestSetResponseHandler_Duplicate_Itself(t *testing.T) {
	...
	post := &entities.Post{ID: 1, Number: 1, Title: "The Post #1", Description: "The Description #1"}
	bus.AddHandler(func(ctx context.Context, q *query.GetPostByNumber) error {
		if q.Number == post.Number {
			q.Result = post
			return nil
...
func TestPostCommentHandler(t *testing.T) {
	...
	bus.AddHandler(func(ctx context.Context, c *cmd.AddNewComment) error {
		newComment = c
		c.Result = &entities.Comment{ID: 1, Content: c.Content}
		return nil
	})
...
func TestUpdateCommentHandler_Authorized(t *testing.T) {
	...
	comment := &entities.Comment{ID: 5, Content: "Old comment text", User: mock.AryaStark}
...
func TestUpdateCommentHandler_Unauthorized(t *testing.T) {
	...
	comment := &entities.Comment{ID: 5, Content: "Old comment text", User: mock.JonSnow}
	bus.AddHandler(func(ctx context.Context, q *query.GetCommentByID) error {
		q.Result = comment
		return nil
	})
